...
/**
 * Unit tests for {{ @link JmxClientConfig }}.
 *
 * @author [@Loong Wan](https://github.com/loong10k)
 * @since 1.0.0
 */
@DisplayName("JmxClientConfig Tests")
class JmxClientConfigTest {

    @Test
    @DisplayName("Default constructor creates instance with expected defaults")
    void testDefaults() {
        JmxClientConfig config = new JmxClientConfig();
    ...
    void testGettersAndSetters() {
        ...
        config.setPort(1099);
        assertThat(config.getPort()).isEqualTo(1099);
