...
**Spring Boot Starter for karaf**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/karaf-spring-boot-starter)](https://github.com/easy-4-java/karaf-spring-boot-starter)
...
> **Artifact ID**：`karaf-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**karaf-spring-boot-starter** is a Spring Boot starter that integrates **karaf** for applications using karaf. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume karaf capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using karaf |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for karaf |
| JDK | `17` |
| Coordinates | `io.github.easy4j:karaf-spring-boot-starter:3.2.x.20260527-SNAPSHOT` |
| Config Prefix | `karaf` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers karaf beans automatically |
| Property Binding | ✅ Stable | Binds `karaf.*` to `KarafClientProperties` |
...
<dependency>
    ...
    <artifactId>karaf-spring-boot-starter</artifactId>
...
|---|---|---|:---:|---|:---:|
| `karaf.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl karaf-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `karaf.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/karaf-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/karaf-spring-boot-starter)
